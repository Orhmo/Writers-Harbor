...
function CompletedModal({ handleModal, nextModal }) {
  return (
    <div className='mx-auto my-auto bg-[#387373] shadow-md w-[24rem] md:w-[34rem] h-auto py-4 px-2'>
      ...
      <div className='flex flex-col justify-evenly gap-6 px-4 py-6 h-full'>
        ...
        <p className='font-bold text-2xl text-center text-[#97A6A0]'>
          You've subscribed to our newsletter
        </p>
        <button label='close' onClick={nextModal}>
          <p className='text-[#97A6A0] bg-[#2D3E40]border rounded-lg p-4 font-bold text-lg'>
            Close
          </p>
        </button>
      </div>
