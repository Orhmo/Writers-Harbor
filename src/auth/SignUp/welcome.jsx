    ...
    <div className='flex flex-col overflow-y-hidden mx-8 my-12 md:my-8'>
      <div className='align-center flex items-center justify-center pt-2'>
       ...
       <div className='mt-8 mx-4'>
            <h1 className='text-2xl text-1A1A1A leading-10 tracking--0.5px'>
              Hi there! Your Portal to Literary Discovery.
            </h1>
            <p className='text-16 text-595959 leading-6 tracking-0.3px pt-2'>
              Unleash your creativity by exploring, crafting, and sharing articles. Engage with fellow writers through comments and discussions.
              Embark on a journey of inspiration and growth with us! 
            </p>
        </div>
